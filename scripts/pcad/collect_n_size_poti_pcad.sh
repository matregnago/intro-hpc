...
# interativa (o job 'sleep infinity' na poti) e dispara nele
# scripts/pcad/collect_n_size_poti_node.sh, que roda o experimento E2b
# (escalonamento vs tamanho do problema N, no pico de tile b=500 de E1) no
# $SCRATCH e copia de volta pra ~/intro_hpc/data/.
#
#   uso: bash scripts/pcad/collect_n_size_poti_pcad.sh <JOBID>
#
# JOBID e obrigatorio (passe o do 'sleep infinity' na poti).
#
...
NODE_SCRIPT="scripts/pcad/collect_n_size_poti_node.sh"
...
echo
echo "==> Pronto. Resultados em $SUBMIT_DIR/data/gpu_n_size_poti_$JOBTAG"
