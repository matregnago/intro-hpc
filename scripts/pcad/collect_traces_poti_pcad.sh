...
# scripts/pcad/collect_traces_poti_node.sh, que roda a captura de rastros
# (E4) no $SCRATCH e copia de volta pra ~/intro_hpc/data/.
#
#   uso: bash scripts/pcad/collect_traces_poti_pcad.sh <JOBID>
#
...
NODE_SCRIPT="scripts/pcad/collect_traces_poti_node.sh"
...
echo
echo "==> Pronto. Resultados em $SUBMIT_DIR/data/gpu_traces_poti_$JOBTAG"
