...
# scripts/pcad/collect_block_size_node.sh, que roda o sweep de tile (E1)
# no $SCRATCH e copia de volta pra ~/intro_hpc/data/.
#
# Funciona para poti E tupi: o node script detecta via hostname qual no e,
# e seleciona o DoE CSV + THREADS apropriados.
#
#   uso: bash scripts/pcad/collect_block_size_pcad.sh <JOBID>
#
# JOBID é obrigatório (passe o do 'sleep infinity' no poti ou tupi).
#
...
NODE_SCRIPT="scripts/pcad/collect_block_size_node.sh"
...
echo
echo "==> Pronto. Resultados em $SUBMIT_DIR/data/gpu_tile_<node>_$JOBTAG"
