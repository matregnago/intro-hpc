...
equilibram a carga de trabalho entre os recursos, tanto em ambientes de memória
compartilhada quanto em ambientes distribuídos \cite{aguerrebere2018hdr}.
...
equipados com aceleradores. Diferentemente de abordagens que constroem o DAG
completo da aplicação em memória antes de escaloná-lo, o PaRSEC representa as
dependências entre tarefas de forma compacta e simbólica, o que lhe permite
escalar para milhões de tarefas com baixo overhead e favorecer, de forma
totalmente distribuída, tanto o balanceamento de carga quanto a sobreposição
...
\section{Resultados}
\label{sec:orgc5292f2}

\subsection{Escolha do tamanho de tile}
\label{sec:orgc2cf8d2}
...
\caption{\label{fig:gflops-b}GFLOPS em função do tamanho de tile \(b\), por algoritmo e máquina.}
\end{figure}
