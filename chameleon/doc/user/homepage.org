...
:END:
  ...
  |-----------+----------------+------------+--------------+-------------------|
  | [[https://gitlab.inria.fr/solverstack/chameleon][Chameleon]] | [[https://gitlab.inria.fr/api/v4/projects/616/packages/generic/source/v1.4.0/chameleon-1.4.0.tar.gz][v1.4.0]]         | [[https://gitlab.inria.fr/solverstack/brew-repo][brew-repo]]  | [[https://gitlab.inria.fr/guix-hpc/guix-hpc-non-free][guix-repo]]    | [[https://github.com/spack/spack][spack-repo]]        |
  ...
  All these packages have been successfully installed and tested on Unix systems: *Linux* (Debian testing, Ubuntu 24.04
  LTS) and *macOS* (Homebrew package).
...
:END:
     ...
     - [[https://cpe.ext.hpe.com/docs/24.07/csml/cray_libsci.html][HPE libSCI]] can also be used on compatible HPE supercomputers (/e.g./ [[https://www.cines.fr/calcul/adastra/][Adastra]]).
     ...
     #+begin_src sh :eval never-export
     wget https://gitlab.inria.fr/api/v4/projects/616/packages/generic/source/v1.4.0/chameleon-1.4.0.tar.gz
     tar xvf chameleon-1.4.0.tar.gz
     cd chameleon-1.4.0
     ...
     cmake -B build -DCHAMELEON_USE_MPI=ON -DBUILD_SHARED_LIBS=ON -DCMAKE_INSTALL_PREFIX=$HOME/install
...
:END:
     ...
     brew install autoconf automake bison bzip2 doxygen emacs htop hwloc libomp libtool openblas openmpi pkgconfig tmux zlib
     ...
     # -L/usr/local/Cellar/openblas/0.3.30/lib -lopenblas
     #+end_src
     ...
     You can use the Homebrew packages available in [[https://gitlab.inria.fr/solverstack/brew-repo][brew-repo]]
     #+begin_src sh :eval never-export
     git clone https://gitlab.inria.fr/solverstack/brew-repo.git
     brew tap homebrew/solverstack ./brew-repo
     brew install starpu chameleon
     #+end_src

     Or install manually StarPU and Chameleon
     #+begin_src sh :eval never-export
...
:END:
  ...
  * [[https://guix-hpc.gitlabpages.inria.fr/compas-tutorial-2025/executions-linalg-hpc/index.html][Compas 2025]]  (in French)
  * [[https://solverstack.gitlabpages.inria.fr/pages/faq.html][Solverstack FAQ]]
